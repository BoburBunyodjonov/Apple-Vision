...
const App = () => {
  ...
  const page7CanvasRef = useRef(null);
  const page18CanvasRef = useRef(null);
  ...
  useEffect(() => {
    ...
    const canvas = () => {
      const canvasElement = page18CanvasRef.current;
      if (!canvasElement) {
        console.error("Canvas element not found for page18");
        return;
      }
  ...
  return (
    <div id="main" ref={mainRef}>
      ...
      <div id="page4">
        <div id="center-page4">
          <h1>Perfect the shot with Dolby HDR</h1>
          <img src="./Apple vision image.png" alt="" />
        </div>
      </div>
      <div id="page5">
        <h1>Unmatched cinematic range with HDR</h1>
        <video
          src="https://www.apple.com/105/media/us/apple-vision-pro/2023/7e268c13-eb22-493d-a860-f0637bacb569/anim/cinematic-range/large.mp4"
          autoPlay
          loop
          muted
        ></video>
      ...
      <div id="page6">
        <h1>Experience stunning color precision</h1>
        <video
          src="https://www.apple.com/105/media/us/apple-vision-pro/2023/7e268c13-eb22-493d-a860-f0637bacb569/anim/true-color/large.mp4"
          autoPlay
          loop
          muted
        ></video>
      ...
      <div id="page7">
        <h1>Multi-stream HDR workflow</h1>
        <canvas ref={page7CanvasRef}></canvas>
      </div>
      <div id="page8">
        <h1>Explore 8K editing</h1>
        <video
          src="https://www.apple.com/105/media/us/apple-vision-pro/2023/7e268c13-eb22-493d-a860-f0637bacb569/anim/8k-editing/large.mp4"
          autoPlay
          loop
          muted
        ></video>
      ...
      <div id="page9">
        <h1>Up to 32-core CPU for faster rendering</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page10">
        <h1>Enhanced thermal architecture for sustained performance</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page11">
        <h1>Bring every detail to life with high-resolution screens</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page12">
        <h1>Robust IO for high-bandwidth workflow</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page13">
        <h1>Superfast SSD storage</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page14">
        <h1>From initial shoot to final cut, Vision Pro has you covered.</h1>
        <video
          src="https://www.apple.com/105/media/us/apple-vision-pro/2023/7e268c13-eb22-493d-a860-f0637bacb569/anim/final-cut/large.mp4"
          autoPlay
          loop
          muted
        ></video>
      ...
      <div id="page15">
        <h1>Intuitive Final Cut Pro interface</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page16">
        <h1>Powerful editing tools for pros and beginners alike</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page17">
        <h1>Take your edits further with Motion and Compressor</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
      <div id="page18">
        <h1>High-performance render engine</h1>
        <canvas  ref={page18CanvasRef}></canvas>
      </div>
      <div id="page19">
        <h1>Real-time VR preview</h1>
        <video
          src="https://www.apple.com/105/media/us/apple-vision-pro/2023/7e268c13-eb22-493d-a860-f0637bacb569/anim/vr-preview/large.mp4"
          autoPlay
          loop
          muted
        ></video>
      ...
      <div id="page20">
        <h1>Immersive AR workspace</h1>
        <video
          src="https://www.apple.com/105/media/us/apple-vision-pro/2023/7e268c13-eb22-493d-a860-f0637bacb569/anim/ar-workspace/large.mp4"
          autoPlay
          loop
          muted
        ></video>
      ...
      <div id="page21">
        <h1>Expand your workspace with TrueDepth Camera</h1>
        <img id="troff" src="./Apple vision image.png" alt="" />
      </div>
      <div id="page22">
        <h1>Streamline your workflow with Siri voice commands</h1>
        <img id="snroff" src="./Apple vision image.png" alt="" />
      </div>
      <div id="page23">
        <h1>Effortlessly share your edits with AirDrop</h1>
        <img src="./Apple vision image.png" alt="" />
      </div>
    </div>
  );
